...
// Project imports:
import 'package:{{name.snakeCase()}}/features/{{name.snakeCase()}}/data/providers/data_sources/{{name.snakeCase()}}_mock_data_source_provider.dart';
import 'package:{{name.snakeCase()}}/features/{{name.snakeCase()}}/data/repositories/{{name.snakeCase()}}_mock_repository_impl.dart';
