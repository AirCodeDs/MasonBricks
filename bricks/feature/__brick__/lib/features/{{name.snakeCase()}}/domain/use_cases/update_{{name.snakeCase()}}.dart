...
class Update{{name.pascalCase()}} implements UseCase<{{name.pascalCase()}}Model, TemplateParams> {
  Update{{name.pascalCase()}}(this.{{name.camelCase()}}RepositoryImpl);
  ...
  Future<Either<Failure, {{name.pascalCase()}}Model>> call(
    TemplateParams templateParams,
      ...
      {{name.camelCase()}}RepositoryImpl.update{{name.pascalCase()}}(templateParams);
}
