...
class DeleteRealEstate implements UseCase<ApiResponse, ParamOne> {
  DeleteRealEstate(this.realEstateRepositoryImpl);
  ...
  Future<Either<Failure, ApiResponse>> call(
    ParamOne paramOne,
      ...
      realEstateRepositoryImpl.deleteRealEstate(paramOne);
}